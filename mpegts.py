...
class WebRTCClient:
    ...
    def on_negotiation_needed(self, element):
        self.webrtc.disconnect_by_func(self.on_negotiation_needed)  # Disconnect handler
...
def create_pipeline():
    pipeline_str = f"""
    filesrc location=/home/elbit/Desktop/flights/VNIR_ZOOM.ts ! tsdemux ! h265parse ! nvh265dec ! x264enc ! h264parse ! rtph264pay ! 
